...
Yanfly.BEC.version = 1.52;

//=============================================================================
/*:
 * @plugindesc v1.52 Have more control over the flow of the battle system
 ...
 *
 * Version 1.52:
 * - Fixed a bug where dead enemies could be forced to take actions,
 * resulting in an error. Fixed by Toby Yasha
 *
 * Version 1.51:
 ...
 */
//=============================================================================
// Added by Toby Yasha in regards to the 'removeCurrentAction' of null Bug
...
// Make sure user is still alive, although if user doesn't exist this won't do anything
Game_Battler.prototype.removeCurrentAction = function () {
    if (this._hp > 0 && this._actions.length > 0) {
        this._actions.shift();
    }
};
...
BattleManager.endAction = function () {
    if (this._subject) {
        ...
        // [Note] Dead Enemies shouldn't be able to use forced actions. (Toby Yasha)
...
Window_Help.prototype.drawSpecialSelectionText = function (action) {
    const determineNumeral = (number, first, second, third) => {
        number %= 100;
